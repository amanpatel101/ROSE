...
sys.path.append("/broad/compbio/aspatel/se_project/newpeakexplore/ROSE_code/")
import ROSE_utils
...
#def mapBamToGFF(bamFile,gff,sense = 'both',unique = 0,extension = 200,floor = 0,density = False,rpm = False,binSize = 25,clusterGram = None,matrix = None,raw = False,includeJxnReads = False):
    ...
    print("RPM", str(rpm))
    if rpm:  
        print("Reads",str(bam.getTotalReads('mapped'))) 
        print(type(bam.getTotalReads('mapped'))) 
    ...
    print("Starting processing lines")
    ticker = 0
